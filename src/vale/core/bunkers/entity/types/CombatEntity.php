...
use vale\core\bunkers\entity\shop\menu\types\BuyMenu;
...
class CombatEntity extends Entity
{
	...
	public function __construct(Location $location, ?Team $team = null, ?CompoundTag $nbt = null)
	{
		...
		$this->team = $team;
		$this->shopType = ShopType::COMBAT;
		$this->setNameTagAlwaysVisible();
		$this->setFallDistance(0);
		$this->setNameTag(TeamManager::$formats[$team->getName()]. " Combat Shop");
	}
	...
	public function attack(EntityDamageEvent $source): void //for some reason u cant hit the entity so you should move this to a listener
	{
